  ...
  return (
    <div className="dropdown dropdown-end">
      ...
      <AnimatePresence>
        <motion.ul
          tabIndex={0}
          className="dropdown-content z-[9999] menu p-2 shadow-xl bg-base-100 rounded-box w-48 sm:w-64 max-h-48 sm:max-h-64 overflow-y-auto border border-base-300"
        ...
        >
          {isLoading ? (
            ...
            <li>
              <span className="text-base-content/60 text-sm">No files uploaded</span>
            </li>
          ) : (
            files.map((filename) => (
              <motion.li
