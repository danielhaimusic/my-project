      ...
      >
        ...
        <div className="card-body items-center justify-center relative z-10">
          <div className="text-center">
            ...
            <TypewriterText text="Select a PDF to unlock intelligent data extraction" />
          </div>
        </div>
      </motion.div>
    );
        ...
        {loading ? (
          <div className="flex-1 flex items-center justify-center">
            ...
            >
              ...
              <TypewriterText text="AI analyzing document structure..." />
              <motion.div
          ...
          <AnimatePresence>
            ...
            >
              ...
              <motion.div
                ...
                initial={{ opacity: 0 }}
                animate={{ opacity: showData ? 1 : 0 }}
                transition={{ delay: 0.5 }}
              >
                <motion.div
                  className="bg-base-200/50 backdrop-blur-sm p-3 rounded-lg border border-primary/20"
                  whileHover={{ scale: 1.02, borderColor: "rgba(59, 130, 246, 0.5)" }}
                  transition={{ duration: 0.3 }}
                >
                  <div className="text-sm font-medium text-base-content/70">Supplier</div>
                  <div className="font-semibold">
                    {showData ? (
                      <TypewriterText text={data.supplier_name || 'N/A'} speed={50} />
                    ) : (
                ...
                <motion.div
                  className="bg-base-200/50 backdrop-blur-sm p-3 rounded-lg border border-secondary/20"
                  whileHover={{ scale: 1.02, borderColor: "rgba(16, 185, 129, 0.5)" }}
                  transition={{ duration: 0.3 }}
                >
                  <div className="text-sm font-medium text-base-content/70">Order Number</div>
                  <div className="font-semibold">
                    {showData ? (
                      <TypewriterText text={data.order_number || 'N/A'} speed={50} delay={500} />
                    ) : (
              ...
              <motion.div
                ...
                transition={{ delay: 1 }}
              >
                {/* ... keep existing code (table structure and pagination) */}
                ...
                <motion.div
                  className="flex-1 overflow-auto border border-base-300 rounded-lg"
          ...
          >
            <div className="text-center">
              ...
              <TypewriterText text="Ready to extract data with AI precision" />
            </div>
          </motion.div>
        )}
      </div>
